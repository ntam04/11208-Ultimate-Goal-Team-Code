...
@Autonomous(name = "Red Duck Compliment")
public class RedDuckCompliment extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory driveToGoal3 = drive.trajectoryBuilder(driveToGoal2.end())
                .splineToLinearHeading(new Pose2d(-32,-24, Math.toRadians(180)), Math.toRadians(330))
                .build();

        Trajectory driveToDuck1 = drive.trajectoryBuilder(driveToGoal3.end())
                .splineToLinearHeading(new Pose2d(-58,-18, Math.toRadians(0)), Math.toRadians(250))
                .build();
