...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 0.966;
    ...
    private DcMotorEx front_right_motor, back_right_motor, front_left_motor, back_left_motor;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        motors = Arrays.asList(front_left_motor, back_left_motor, back_right_motor, front_right_motor);
    ...
    public void setMotorPowers(double v, double v1, double v2, double v3) {
        front_left_motor.setPower(v);
        back_left_motor.setPower(v1);
        back_right_motor.setPower(v2);
        front_right_motor.setPower(v3);
    }
